	            ...
	            <div class="panel-body">
					<form id="defaultForm" class="form-horizontal">
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control" name="promotionName" maxlength="100" />
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-5">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="promotionStatus" value="1" checked="true"/>启用
                                    </label>
                                    &nbsp;
                                    <label>
                                        <input type="radio" name="promotionStatus" value="0" /> 禁用
                                    </label>
                                </div>
                            </div>
                        </div>
